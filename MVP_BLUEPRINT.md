...
Notifications table:
notification_id (PK), user_id (FK → user_table.user_id), ticket_id (FK → ticket.ticket_id), message, is_read (T/F), created_at

Buildings table:
Building_id, building_name

Floors table:
Floor_id, floor_number, building_id (FK)

Seats table:
Seat_id, seat_number, floor_id(FK)
